...
<MiniRepl client:idle tune={`"[c d e f g a b]".segment(4).pick("0 1 2").note().s('piano')`} punchcard punchcardLabels={false} />

Picks specific indices from the segmented chunk.
