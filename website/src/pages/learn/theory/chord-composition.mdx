...
<MiniRepl client:idle tune={`chord("<C Cm Co C+ Csus C5>").voicing().s("piano").slow(1.5)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`chord("<C^7 C7 Cm7 Cm7b5 Co7 CmM7>").voicing().s("piano").slow(1.5)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`chord("<C9 C^9 Cadd9 C11 C^7#11 C13>").voicing().s("piano").slow(1.5)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`chord("<G7 G7b9 G7#9 G7alt>").voicing().s("piano")`} punchcard punchcardLabels={false} />

#### Slash Chords (Bass Notes)

Add `/note` to specify a bass note different from the root:

<MiniRepl client:idle tune={`chord("<C C/E C/G Am/E>").voicing().s("piano")`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`chord("<Dm7 G7 C^7 A7>").voicing().s("piano")`} punchcard punchcardLabels={false} />

**Neo-Soul/R&B:** `C^9`, `Dm9`, `Em9`, `F^7#11`

<MiniRepl client:idle tune={`chord("<C^9 Dm9 Em9 F^7#11>").voicing().s("piano")`} punchcard punchcardLabels={false} />

**Lo-fi/Chill:** `Cmaj7`, `Am7`, `Dm7`, `G7`

<MiniRepl client:idle tune={`chord("<C^7 Am7 Dm7 G7>").voicing().s("piano").room(0.4)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`chord("<C^7 Dm7 G7 C^7>").anchor("c5").voicing().s("piano")._pitchwheel()`} />
...
<MiniRepl client:idle tune={`chord("<C^7 Dm7 G7 C^7>").voicing().s("piano")._pitchwheel()`} />
...
<MiniRepl client:idle tune={`chord("<C C^7 C^9 C13>").voicing().s("piano")._pitchwheel()`} />
...
<MiniRepl client:idle tune={`chord("<Csus C>").voicing().s("piano")`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`n("0 1 2 3 2 1").chord("<C^7 Am7>").voicing().note().s('piano')._pitchwheel()`} />
