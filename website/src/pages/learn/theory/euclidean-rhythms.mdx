...
<MiniRepl client:visible tune={`sound("bd [~ bd] ~ ~ ~ bd ~")`} punchcard punchcardLabels={false} />

**Pattern B:**

<MiniRepl client:visible tune={`sound("bd").euclid(3, 8)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:visible tune={`sound("bd").euclid(2, 8)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:visible tune={`sound("bd").euclid(5, 8)`} punchcard punchcardLabels={false} />

**Very Dense (7 in 8):**

<MiniRepl client:visible tune={`sound("bd").euclid(7, 8)`} punchcard punchcardLabels={false} />
...
<QA client:load question="How does the Bjorklund algorithm work? (Mathematical details)">
...
**Why this works:**
The pairing process minimizes the difference between gap sizes. By recursively distributing the items, it ensures no two gaps differ by more than 1 step—achieving maximal evenness.
...
<QA client:load question="The GCD Rule (Mathematical explanation)">

**The GCD Rule:**

If GCD(pulses1, pulses2) = 1 (coprime numbers), patterns won't sync until lcm(steps1, steps2).

**Example:**
- Pattern A: (5,8)
- Pattern B: (7,12)
- GCD(5,7) = 1 (coprime)
- Combined cycle: lcm(8,12) = 24 steps

This creates maximum rhythmic variety before the full pattern repeats.

**Why this matters:**
Coprime pulse numbers ensure the patterns hit together as infrequently as possible, maximizing the variety of rhythmic combinations. Non-coprime numbers (like 4 and 6, GCD=2) sync more often, creating more predictable patterns.

**Practical application:**
Choose pulse counts with GCD=1 for evolving, hypnotic grooves. Use pulse counts that share factors (GCD>1) for more stable, locked-in feels.
...
<QA client:load question="Pattern Independence: The Power of Mismatched Cycles (Mathematical explanation)">
...
**The math behind it:**
The full pattern repeats after lcm(note_count, hit_count) hits. For 4 notes and 3 hits: lcm(4,3) = 12 hits.

**Pro tip:** Try GCD(notes, hits) = 1 (coprime numbers) for maximum variation before repetition. Example: (7 notes, 5 hits) won't repeat for 35 iterations because lcm(7,5) = 35.

**Why coprime matters:**
- Coprime (GCD=1): Maximum variation, longest evolution
- Non-coprime (GCD>1): Shorter cycles, more predictable repetition
...
<MiniRepl client:idle tune={`note("c2 e2 g2 b2").s("sawtooth").lpf(800).euclid(5, 16)`} punchcard punchcardLabels={false} />
...
- Fela Kuti - ["Water No Get Enemy"](https://www.youtube.com/watch?v=IQBC5URoF0s) (definitive Afrobeat)
- Tony Allen - ["Asiko"](https://www.youtube.com/watch?v=jQ5ohoHWLXQ) (the master drummer's solo work)
...
**Classic tracks:**
- Bob Marley - ["One Drop"](https://www.youtube.com/watch?v=u8n_14AsBKs) (literally named for the pattern)
- Augustus Pablo - ["King Tubby Meets Rockers Uptown"](https://www.youtube.com/watch?v=wbCrYBWh62Y) (dub perfection)
...
**Classic tracks:**
- João Gilberto - ["Chega de Saudade"](https://www.youtube.com/watch?v=yUuJrpP0Mak) (the track that started it all)
- Stan Getz & João Gilberto - ["The Girl from Ipanema"](https://www.youtube.com/watch?v=c5QfXjsoNe4) (global crossover hit)
...
- John Lee Hooker - ["Boom Boom"](https://www.youtube.com/watch?v=X70VMrH3yBg)
- Muddy Waters - ["Mannish Boy"](https://www.youtube.com/watch?v=bSfqNEvykv0)
- ZZ Top - ["La Grange"](https://www.youtube.com/watch?v=Vppbdf-qtGU) (rock shuffle)
...
- Marshall Jefferson - ["Move Your Body"](https://www.youtube.com/watch?v=QAR8cq5Bl94) (house anthem)
- Frankie Knuckles - ["Your Love"](https://www.youtube.com/watch?v=LOLE1YE_oFQ)
- Mr. Fingers - ["Can You Feel It"](https://www.youtube.com/watch?v=tFuujExs03A)
...
).bank("RolandTR707").cpm(29)`} punchcard punchcardLabels={false} />
...
**Historical context:**
The dembow originated in Jamaican dancehall with Shabba Ranks' 1990 track "Dem Bow." Puerto Rican DJs adopted and transformed it into reggaeton's signature rhythm. Today it dominates global pop through artists like Bad Bunny, Daddy Yankee, and J Balvin.

**Classic dembow tracks:**
- Shabba Ranks - ["Dem Bow"](https://www.youtube.com/watch?v=MhH2jbvjkPg) (the original)
- Daddy Yankee - ["Gasolina"](https://www.youtube.com/watch?v=CCF1_jI8Prk) (global reggaeton breakthrough)
- Bad Bunny - ["Dakiti"](https://www.youtube.com/watch?v=TmKh7lAwnBI) (modern dembow)
...
**African/Afrobeat:**
- Fela Kuti - ["Zombie"](https://www.youtube.com/watch?v=Qj5x6pbJMyU), ["Water No Get Enemy"](https://www.youtube.com/watch?v=IQBC5URoF0s)
- Tony Allen - ["Secret Agent"](https://www.youtube.com/watch?v=jTeZNuvlxzU), ["Asiko"](https://www.youtube.com/watch?v=jQ5ohoHWLXQ)
- King Sunny Adé - Master of Yoruba juju music

**Latin:**
- Tito Puente - ["Oye Como Va"](https://www.youtube.com/watch?v=zZQh4IL7unM) (Cuban timbale master)
- Buena Vista Social Club - ["Chan Chan"](https://www.youtube.com/watch?v=tGbRZ73NvlY) (Traditional son cubano)
- João Gilberto - ["Chega de Saudade"](https://www.youtube.com/watch?v=yUuJrpP0Mak) (Bossa nova pioneer)

**Electronic:**
- Aphex Twin - ["Windowlicker"](https://www.youtube.com/watch?v=UBS4Gi1y_nc) (Complex euclidean-style programming)
- Autechre - ["Gantz Graf"](https://www.youtube.com/watch?v=ev3vENli7wQ) (Algorithmic rhythms and polymeters)
- Squarepusher - ["My Red Hot Car"](https://www.youtube.com/watch?v=SqjZUyUtqYs) (Drum machine wizardry)

**Minimalism:**
- Steve Reich - ["Clapping Music"](https://www.youtube.com/watch?v=lzkOFJMI5i8), ["Drumming"](https://www.youtube.com/watch?v=uDhwFTw4VnI) (phasing rhythms)
- Terry Riley - ["In C"](https://www.youtube.com/watch?v=yNi0bukYRnA) (repeating patterns)
