...
<MiniRepl client:visible tune={`stack(
  note("fs4 e4 d4 cs4 b3 a3 b3 cs4 ~").s('piano'),
  chord("<D A Bm F#m G D G A>").voicing().s('piano').gain(0.6),
  chord("<D A Bm F#m G D G A>").rootNotes(2).note().s('sawtooth').lpf(600).gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("fs4 e4 d4 cs4 b3 a3 b3 cs4 ~ c4 d4 e4 ~").fast(3/2).s('piano'),
  chord("<D A Bm F#m G D G A>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("fs4 e4 d4 cs4 b3 a3 b3 cs4 ~").s('piano'),
  note("d3 a3 g3 fs3 d3 a3 fs3 ~").s('piano').gain(0.7),
...
<MiniRepl client:idle tune={`slowcat(
  ...
  stack(
    ...
    chord("<A D E A>").voicing().s('piano').gain(0.6)
  ).fast(4)
).slow(4).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`slowcat(
  ...
  stack(
    note("fs4 e4 d4 cs4 b3 a3 b3 a3 ~").s('piano'),
    chord("<Bm Em F#m Bm>").voicing().s('piano').gain(0.6)
  ).fast(4)
).slow(4).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  // Voice 1: Subject in D
  note("d4 fs4 e4 g4 fs4 a4 g4 fs4").s('piano'),
  // Voice 2: Answer in A (enters later)
  note("a3 cs4 b3 d4 cs4 e4 d4 cs4").late(1).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("d4 fs4 e4 g4 fs4 a4 g4 fs4").s('piano'),
  note("d4 fs4 e4 g4 fs4 a4 g4 fs4").transpose(7).late(1).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
The first 4 notes of the subject (D-F#-E-G) repeat as a sequence, moving up by step. This is typical of fugue episodes—taking a recognizable fragment and developing it.

**Episode with inversion:**

<MiniRepl client:idle tune={`stack(
  note("d4 fs4 e4 g4 fs4 a4 g4 fs4").s('piano'),
  note("d4 b3 cs4 a3 b3 g3 a3 b3").late(1).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`slowcat(
  ...
  stack(
    ...
    note("d3 fs3 e3 g3 e3 g3 fs3 a3").s('piano').gain(0.7)
  ),
...
<MiniRepl client:idle tune={`slowcat(
  ...
  stack(
    note("d4 e4 fs4 g4 a4 g4 fs4 e4").s('piano'),
    note("a3 b3 cs4 d4 e4 d4 cs4 b3").late(1).s('piano').gain(0.7)
  ).fast(4),
  // Exposition of Subject 2
  stack(
    note("d4 ~ fs4 ~ a4 ~ d5 ~").s('piano'),
    note("a3 ~ cs4 ~ e4 ~ a4 ~").late(1).s('piano').gain(0.7)
  ).fast(4),
  // Both subjects combined
  stack(
    note("d4 e4 fs4 g4 a4 g4 fs4 e4").s('piano'),
