...
**Here's a simple 4-bar theme in C major:**

<MiniRepl client:visible tune={`note("c4 d4 e4 f4 e4 d4 c4").s('piano').cpm(30)`} punchcard punchcardLabels={false} />

This theme is simple, memorable, and has a clear shape (up and back down). Let's see if it has what it takes for classical development.
...
Yes—the theme ends on C and can loop seamlessly.

**Does it transpose well?**

<MiniRepl client:visible tune={`note("c4 d4 e4 f4 e4 d4 c4 ~").transpose("<0 5 7 0>").s('piano').cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:visible tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  note("c4 bb3 a3 g3 a3 bb3 c4 ~").s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />

The original goes up then down. The inversion goes down then up. Both work harmonically—this theme is developable!

---

### Adding Harmonic Support

Classical music combines melody with harmony. Let's add chords underneath our theme using `chord().voicing()`:

**Theme with simple harmonic support:**

<MiniRepl client:visible tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  chord("<C F G C>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

The chords (C → F → G → C) provide harmonic movement that supports the melody.
...
<MiniRepl client:visible tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  chord("<C F G C>").voicing().s('piano').gain(0.6),
  chord("<C F G C>").rootNotes(2).note().s('sawtooth').lpf(600).gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />

Now we have a complete texture: melody, harmony, and bass. This is our foundation theme—let's develop it!
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").slow(2).s('piano'),
  chord("<C F G C>").slow(2).voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").fast(2).s('piano'),
  chord("<C F G C>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").late(0.125).s('piano'),
  chord("<C F G C>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
Grouping notes in threes using `.fast(3/2)`:

<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~ c4 d4 e4 ~").fast(3/2).s('piano'),
  chord("<C F G C>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

Triplets add a flowing, lilting quality. Classical composers preferred even subdivision, while Romantic composers loved triplet figures.
...
<MiniRepl client:idle tune={`stack(
  note("c4 [d4 c4 d4] e4 [f4 e4 f4] e4 d4 c4 ~").s('piano').decay(0.2),
  chord("<C F G C>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

The brackets `[d4 c4 d4]` create quick ornamental figures around the main notes—similar to trills and turns in classical music.
...
<MiniRepl client:idle tune={`stack(
  note("c5 d4 e5 f4 e4 d5 c4 ~").s('piano'),
  chord("<C F G C>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  chord("<C Dm Em F Em Dm C>").voicing().arp("0 1 2 1").s('piano').octave(4),
  chord("<C F G C>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  cat(
    note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
    note("d4 e4 f4 g4 f4 e4 d4 ~").s('piano')
  ),
  chord("<C F G C D G C G>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

The theme repeats one step higher (C→D). Baroque composers, especially Vivaldi, used sequences extensively in concertos.
...
<MiniRepl client:idle tune={`stack(
  note("c4 bb3 a3 g3 a3 bb3 c4 ~").s('piano'),
  chord("<C F G C>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

Where the original went up, the inversion goes down—a mirror image.
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 eb4 f4 eb4 d4 c4 ~").s('piano'),
  chord("<Cm Fm G Cm>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

Notice the E becomes Eb (flat) to fit the C minor tonality. The theme takes on a darker, more melancholic character.
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  chord("<C Am Dm G>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

Instead of C → F → G → C, we use C → Am → Dm → G. The melody is the same, but the harmonic color is different.
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  chord("<C E7 Am D7 G7 C>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

The E7, D7, and G7 are chromatic chords (secondary dominants) that add harmonic color. Romantic composers explored chromatic harmony extensively.
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  chord("<C F G C>").voicing().s('piano').gain(0.6),
  note("c2").s('sawtooth').lpf(400).sustain(2)
).cpm(30)`} punchcard punchcardLabels={false} />

The low C sustains throughout while chords change above—creating harmonic tension and release.
...
<MiniRepl client:idle tune={`note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano').cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`chord("<C Dm Em F Em Dm C>").voicing().struct("x").s('piano').cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  note("c3 f3 e3 d3 c3 g3 e3 ~").s('piano').gain(0.7),
  chord("<C F G C>").voicing().s('piano').gain(0.5)
).cpm(30)`} punchcard punchcardLabels={false} />
...
).slow(4).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:visible tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  note("c4 d4 e4 f4 e4 d4 c4 ~").late(0.5).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  note("c4 d4 e4 f4 e4 d4 c4 ~").transpose(12).late(0.5).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  note("c4 d4 e4 f4 e4 d4 c4 ~").transpose(7).late(0.5).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  note("c4 d4 e4 f4 e4 d4 c4 ~").slow(2).transpose(12).s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 g3").s('piano'),
  note("c4 d4 e4 f4 e4 d4 c4 g3").rev().transpose(12).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  note("c4 d4 e4 f4 e4 d4 c4 ~").late(0.333).transpose(12).s('piano').gain(0.7),
  note("c4 d4 e4 f4 e4 d4 c4 ~").late(0.666).transpose(-12).s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano').gain(0.8),
  note("c4 d4 e4 f4 e4 d4 c4 ~").late(0.25).transpose(7).s('piano').gain(0.7),
  note("c4 d4 e4 f4 e4 d4 c4 ~").late(0.5).transpose(-5).s('piano').gain(0.7),
  note("c4 d4 e4 f4 e4 d4 c4 ~").late(0.75).transpose(-12).s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 e4 g4 c5 g4 e4 c4 ~").s('piano'),
  note("c4 e4 g4 c5 g4 e4 c4 ~").late(0.5).transpose(12).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />

The melody ends on C and begins on C, allowing seamless looping. "Frère Jacques" uses this structure.
...
<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  note("c4 d4 e4 f4 e4 d4 c4 ~").late(0.125).transpose(12).s('piano').gain(0.7),
  note("c4 d4 e4 f4 e4 d4 c4 ~").late(0.25).transpose(7).s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  ...
  // Harmonic support
  chord("<C F G C>").voicing().s('piano').gain(0.5),
  chord("<C F G C>").rootNotes(2).note().s('sawtooth').lpf(600).gain(0.6),
...
**Original harmonization (I-IV-V-I):**
...
This uses the most basic progression: C (I) → F (IV) → G (V) → C (I).

**Reharmonization 1 (vi-ii-V-I):**

<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  chord("<Am Dm G C>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

Same melody, but using Am (vi) → Dm (ii) → G (V) → C (I). This is a more "sophisticated" progression with smoother voice leading.

**Reharmonization 2 (ii-V-I jazz style):**

<MiniRepl client:idle tune={`stack(
  note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
  chord("<Dm7 G7 C^7>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

Using seventh chords (Dm7 → G7 → C^7) adds harmonic color—influenced by jazz harmony.
...
Adding chromatic chords (E7, D7) creates harmonic tension and color. Romantic composers explored this extensively—reharmonizing simple themes with rich, chromatic harmony.
...
**Modulation to the Dominant (C → G)**

Moving from C major to G major (the dominant key):

<MiniRepl client:idle tune={`slowcat(
  // Theme in C major (bars 1-2)
  stack(
    note("c4 d4 e4 f4 e4 d4 c4 ~").s('piano'),
    chord("<C F G C>").voicing().s('piano').gain(0.6)
  ).fast(4),
  // Theme in G major (bars 3-4)
  stack(
    note("c4 d4 e4 f4 e4 d4 c4 ~").transpose(7).s('piano'),
    chord("<G C D G>").voicing().s('piano').gain(0.6)
  ).fast(4)
).slow(4).cpm(30)`} punchcard punchcardLabels={false} />

The theme transposes up 7 semitones (perfect fifth) to G major. Classical composers modulated to the dominant in sonata form expositions.

**Modulation to the Relative Minor (C → Am)**
...
<MiniRepl client:idle tune={`slowcat(
  ...
  // Theme in A minor (relative minor)
  stack(
    note("a3 b3 c4 d4 c4 b3 a3 ~").s('piano'),
    chord("<Am Dm E Am>").voicing().s('piano').gain(0.6)
  ).fast(4)
).slow(4).cpm(30)`} punchcard punchcardLabels={false} />

A minor is the relative minor of C major (shares the same key signature). The theme takes on a darker character. Classical composers modulated to closely-related keys; Romantic composers explored distant keys.
...
<MiniRepl client:idle tune={`stack(
  ...
  chord("<C F Dm G Em Am>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

The same melodic shape (ascending stepwise) repeats at C, D, and E—climbing higher each time.
...
<MiniRepl client:idle tune={`stack(
  ...
  chord("<C F Bb Eb Am Dm>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  cat(
    note("c4 d4 e4 f4 e4 d4 c4 ~"),
    note("d4 e4 f4 g4 f4 e4 d4 ~"),
    note("e4 f4 g4 a4 g4 f4 e4 ~")
  ).s('piano'),
  chord("<C F G C D G A D E A B E>").voicing().s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />

The theme sequences up by step (C → D → E), with harmony following the modulation. Vivaldi's concertos use sequences extensively for harmonic drama. Bach's fugue episodes often feature sequential development.
...
<MiniRepl client:idle tune={`stack(
  // Voice 1: Subject in C
  note("c4 d4 e4 f4 g4 a4 g4 f4").s('piano'),
  // Voice 2: Answer in G (enters later)
  note("g3 a3 b3 c4 d4 e4 d4 c4").late(1).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />

Voice 1 presents the subject in C. Voice 2 enters with the "answer" (subject transposed to the dominant, G).
...
**Example fugue subject in C major:**

<MiniRepl client:visible tune={`note("c4 e4 d4 f4 e4 g4 f4 e4").s('piano').cpm(30)`} punchcard punchcardLabels={false} />

This subject:
- Outlines a C major triad (C-E-G)
- Has a clear rhythmic pattern
- Is 8 notes long (moderate)
- Can be easily fragmented (C-E-D-F could be a motif)
...
<MiniRepl client:idle tune={`stack(
  note("c4 e4 d4 f4 e4 g4 f4 e4").s('piano'),
  note("c4 e4 d4 f4 e4 g4 f4 e4").transpose(7).late(1).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />

The answer is exactly 7 semitones higher (C → G). This is called a "real answer."
...
<MiniRepl client:idle tune={`stack(
  // Voice 1: Subject
  note("c4 e4 d4 f4 e4 g4 f4 e4").s('piano'),
  // Voice 2: Answer (enters after subject completes)
  note("c4 e4 d4 f4 e4 g4 f4 e4").transpose(7).late(1).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />

This is a complete 2-voice fugue exposition: subject, then answer.
...
<MiniRepl client:idle tune={`stack(
  ...
  cat(
    note("c4 e4 d4 f4 e4 g4 f4 e4"),
    note("c3 c3 d3 d3 e3 e3 f3 f3")
  ),
  // Voice 2: Rest, then answer
  cat(
    note("~ ~ ~ ~ ~ ~ ~ ~"),
    note("g3 b3 a3 c4 b3 d4 c4 b3")
  )
...
<MiniRepl client:idle tune={`stack(
  ...
  cat(
    note("c4 e4 d4 f4 e4 g4 f4 e4"),
    note("c3 c3 d3 d3 e3 e3 f3 f3"),
    note("e3 f3 g3 a3 g3 f3 e3 d3")
  ),
  // Voice 2: Rest → answer → counter-subject
  cat(
    note("~ ~ ~ ~ ~ ~ ~ ~"),
    note("g3 b3 a3 c4 b3 d4 c4 b3"),
    note("g2 g2 a2 a2 b2 b2 c3 c3")
  ),
...
<MiniRepl client:idle tune={`stack(
  // Fragment: first 4 notes of subject, sequenced
  cat(
    note("c4 e4 d4 f4"),
    note("d4 f4 e4 g4"),
    note("e4 g4 f4 a4")
  ).s('piano'),
  // Second voice with same fragment, delayed
  cat(
    note("~ ~ c3 e3 d3 f3"),
    note("d3 f3 e3 g3")
  ).s('piano').gain(0.7)
...
The first 4 notes of the subject (C-E-D-F) repeat as a sequence, moving up by step. This is typical of fugue episodes—taking a recognizable fragment and developing it.

**Episode with inversion:**

<MiniRepl client:idle tune={`stack(
  note("c4 e4 d4 f4 e4 g4 f4 e4").s('piano'),
  note("c4 a3 bb3 g3 a3 f3 g3 a3").late(1).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 e4 d4 f4 e4 g4 f4 e4").s('piano'),
  note("c4 e4 d4 f4 e4 g4 f4 e4").late(0.25).transpose(12).s('piano').gain(0.7),
  note("c4 e4 d4 f4 e4 g4 f4 e4").late(0.5).transpose(7).s('piano').gain(0.6)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`slowcat(
  // Section 1: Exposition (voices enter)
  stack(
    note("c4 e4 d4 f4 e4 g4 f4 e4").s('piano'),
    note("~ ~ ~ ~ ~ ~ ~ ~ g3 b3 a3 c4 b3 d4 c4 b3").s('piano').gain(0.7),
    note("~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ c5 e5 d5 f5 e5 g5 f5 e5").s('piano').gain(0.6)
  ),
  // Section 2: Episode (sequences)
  stack(
    note("c4 e4 d4 f4 d4 f4 e4 g4 e4 g4 f4 a4").s('piano'),
    note("c3 e3 d3 f3 d3 f3 e3 g3").s('piano').gain(0.7)
  ),
  // Section 3: Stretto (climax)
  stack(
    note("c4 e4 d4 f4 e4 g4 f4 e4").s('piano'),
    note("c4 e4 d4 f4 e4 g4 f4 e4").late(0.25).transpose(12).s('piano').gain(0.7),
    note("c4 e4 d4 f4 e4 g4 f4 e4").late(0.5).transpose(7).s('piano').gain(0.6)
...
).slow(2).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  cat(
    note("c4 e4 d4 f4 e4 g4 f4 e4"),
    note("d4 f4 e4 g4 f4 a4 g4 f4")
  ).s('piano'),
  cat(
    note("~ ~ ~ ~ g3 b3 a3 c4 b3 d4 c4 b3"),
    note("a3 c4 b3 d4 c4 e4 d4 c4")
  ).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`stack(
  note("c4 e4 d4 f4").s('piano'),
  note("g3 b3 a3 c4").late(0.5).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
**Dominant Pedal (sustaining G):**

<MiniRepl client:idle tune={`stack(
  // Upper voices with subject fragments
  note("c4 e4 d4 f4").s('piano'),
  note("g4 b4 a4 c5").late(0.25).s('piano').gain(0.7),
  // Pedal point on G (dominant)
  note("g2").s('sawtooth').lpf(400).sustain(2).gain(0.8)
).cpm(30)`} punchcard punchcardLabels={false} />

The low G sustains while voices move above, creating tension that resolves to C.
...
<MiniRepl client:idle tune={`stack(
  ...
  note("c4 e4 d4 f4 e4 g4 f4 e4").late(0.5).transpose(7).s('piano').gain(0.6),
  // Tonic pedal point
  note("c2").s('sawtooth').lpf(400).sustain(2).gain(0.8)
).cpm(30)`} punchcard punchcardLabels={false} />

A sustained C under the final stretto creates stability and grandeur—often used in fugue codas.
...
<MiniRepl client:idle tune={`note("c4 d4 e4 f4 g4 f4 e4 d4").s('piano').cpm(30)`} punchcard punchcardLabels={false} />

**Subject 2 (rhythmic, contrasting):**

<MiniRepl client:idle tune={`note("c4 ~ e4 ~ g4 ~ c5 ~").s('piano').cpm(30)`} punchcard punchcardLabels={false} />

**Both subjects combined:**

<MiniRepl client:idle tune={`stack(
  // Subject 1
  note("c4 d4 e4 f4 g4 f4 e4 d4").s('piano'),
  // Subject 2 (works harmonically with Subject 1)
  note("c3 ~ e3 ~ g3 ~ c4 ~").s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`slowcat(
  ...
  stack(
    note("c4 d4 e4 f4 g4 f4 e4 d4").s('piano'),
    note("g3 a3 b3 c4 d4 c4 b3 a3").late(1).s('piano').gain(0.7)
  ).fast(4),
  // Exposition of Subject 2
  stack(
    note("c4 ~ e4 ~ g4 ~ c5 ~").s('piano'),
    note("g3 ~ b3 ~ d4 ~ g4 ~").late(1).s('piano').gain(0.7)
  ).fast(4),
  // Both subjects combined
  stack(
    note("c4 d4 e4 f4 g4 f4 e4 d4").s('piano'),
...
<MiniRepl client:idle tune={`stack(
  ...
  note("c4 d4 e4 f4 e4 d4 c4 ~").fast(2).late(0.5).transpose(12).s('piano').gain(0.7)
).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`slowcat(
  ...
  stack(
    note("c4 e4 d4 f4 e4 g4 f4 e4").s('piano'),
    note("g3 b3 a3 c4 b3 d4 c4 b3").late(1).s('piano').gain(0.7)
  ).fast(4),
  // Episode: Subject in augmentation (slower)
  stack(
    note("c4 e4 d4 f4 e4 g4 f4 e4").slow(2).s('piano'),
    note("e3 f3 g3 a3 g3 f3 e3 d3").s('piano').gain(0.7)
  ).fast(4)
).slow(4).cpm(30)`} punchcard punchcardLabels={false} />
...
<MiniRepl client:idle tune={`slowcat(
  ...
  stack(
    note("c4 d4 eb4 f4 eb4 d4 c4 ~").fast(2).s('piano'),
    chord("<Cm Fm G Cm>").voicing().s('piano').gain(0.6)
  ).fast(4),
  ...
  stack(
    ...
    note("c4 d4 e4 f4 e4 d4 c4 ~").transpose(7).late(0.5).s('piano').gain(0.7),
    // Stretto
    note("c4 d4 e4 f4 e4 d4 c4 ~").late(0.25).transpose(12).s('piano').gain(0.6)
  ).fast(4)
).slow(16).cpm(30)`} punchcard punchcardLabels={false} />
