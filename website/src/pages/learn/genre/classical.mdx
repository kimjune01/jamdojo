...
<MiniRepl client:idle tune={`// Pachelbel - Canon in D
setcps(10/60/2)
...
1. Bach — [Invention No. 1 in C major](https://www.youtube.com/watch?v=iHNxdOTFt7c) (simple 2-voice imitation)
2. Bach — [Fugue in C major (WTC Book I)](https://www.youtube.com/watch?v=g1TSYDqmfuY) (clear fugue structure)
3. Mozart — [Variations on "Ah! vous dirai-je, Maman"](https://www.youtube.com/watch?v=NO-ecxHEPqI) (theme & variations)
4. Pachelbel — [Canon in D](https://www.youtube.com/watch?v=JvNQLJ1_HQ0) (ground bass with canon)
5. Beethoven — [Diabelli Variations](https://www.youtube.com/watch?v=pAI4-9yc6kA) (variation form mastery)
